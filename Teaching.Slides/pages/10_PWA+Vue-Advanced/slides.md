...
![Service Worker](/slides-images/service-worker.png)
...
```javascript {monaco} { lineNumbers: 'on', height: '400px', editorOptions: { fontSize: 11 } }
...
```html {monaco} { lineNumbers: 'on', height: '400px', editorOptions: { fontSize: 11 } }
<template>
  <h2>Friends</h2>
  <ul>
